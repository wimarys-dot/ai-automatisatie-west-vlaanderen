      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-6xl">
            {[
              { label: 'Trigger', title: 'n8n Workflow Hub', desc: 'Het kloppend hart van uw bedrijf.', icon: '⚡', view: 'n8n', color: 'bg-[#ff6d5a]', border: 'hover:border-[#ff6d5a]/50' },
              { label: 'Action', title: 'AI Intelligentie', desc: 'Agents die voor u denken en doen.', icon: '🤖', view: 'agents', color: 'bg-[#7c3aed]', border: 'hover:border-[#7c3aed]/50' },
              { label: 'Storage', title: 'MCP Protocol', desc: 'Veilige verbinding met uw databases.', icon: '💠', view: 'mcp', color: 'bg-[#0ea5e9]', border: 'hover:border-[#0ea5e9]/50' }
            ].map((node, i) => (
              <div 
                key={i}
                onClick={() => setView(node.view as View)}
              ...
              >
                ...
                <div className="text-xs font-bold text-zinc-500 uppercase tracking-widest mb-6 flex items-center gap-2">
